...
namespace MiniPascal.TestSuite
{
    ...
    public sealed class AssigmentTest : RedirectedOutputTest
    {
        ...
        public void AssignInteger()
        {
            ...
            Assert.AreEqual(23123.ToString(), output);
        }
        ...
        public void AssignReal()
        {
            ...
            Assert.AreEqual(12 + "" + (-0.576e3F), output);
        }
        ...
        [Test]
        public void AssignFalseTypeFail()
        {
            Assert.Catch<Parser.AST.TypeMismatchException>(() =>
            {
                Redirect(@"begin var i:integer;i:=false; end.");
            });
        }
    }
}
